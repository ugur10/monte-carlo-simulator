...
<section class="grid gap-6 lg:grid-cols-3">
    ...
    <aside class="space-y-6">
      ...
      <button
        type="button"
        class="w-full rounded-xl bg-primary px-4 py-3 text-sm font-semibold text-slate-950 transition hover:bg-primary-strong focus:outline-none focus:ring-2 focus:ring-primary/50 disabled:cursor-not-allowed disabled:bg-white/10 disabled:text-slate-500"
